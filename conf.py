...
SITE_URL = "https://mipt-npm.github.io/python-scientific-book/"
...
# LOGO_URL = 'https://avatars2.githubusercontent.com/u/38881479?s=200&v=4'
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="mailto:{email}">{author}</a> (Зелёный М. Е. et al.) - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
